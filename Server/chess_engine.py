...
class GameState:
    def __init__(self):
        ...
        self.pins = []
        self.checks = []
        self.enpassant_possible = ()  # bắt tốt qua đường
    ...
    def makeMove(self, move):
        ...
        if move.piece_moved[1] == "p" and abs(move.start_row - move.end_row) == 2:  # chỉ khi di chuyển 2 bước
    ...
    def getValidMoves(self):
        ...
        if self.in_check:
            if len(self.checks) == 1:  # bị 1 quân chiếu, di chuyển vua hoặc chặn
            ...
            for i in range(1, 8):
                ...
                if 0 <= end_row <= 7 and 0 <= end_col <= 7:
                    ...
                    if end_piece[0] == ally_color and end_piece[1] != "K":
                        # nếu chưa có quân ta để chắn cho vua
                        if possible_pin == ():  # first allied piece could be pinned
                            possible_pin = (end_row, end_col, direction[0], direction[1])
                        else:  # có rồi thì thôi
                            break
                    # nếu là quân địch
                        ...
                        if (0 <= j <= 3 and enemy_type == "R") or (4 <= j <= 7 and enemy_type == "B") or \
                                ...
                                or (enemy_type == "Q") or (i == 1 and enemy_type == "K"):
